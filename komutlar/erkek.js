...
const tag = 'Ψ'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '809285603530637369') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '809285603530637368')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '809285603485024314')
const genelchat = message.guild.channels.cache.find(c => c.id === '809285605988630539')
const savelog = message.guild.channels.cache.find(c => c.id === '809285610707091464')
